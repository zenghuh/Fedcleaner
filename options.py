...
def args_parser():
    ...
    parser.add_argument('--attack_round', type=int, default=10,
                        help='attack round')
    parser.add_argument('--h_reg', type=float, default=0.01,
                        help='Hessian regularization')
    ...
    parser.add_argument('--tm_belta', type=float, default=0,
                        help='belta for trimmed mean')
